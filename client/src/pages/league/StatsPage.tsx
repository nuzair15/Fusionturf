...
export function StatsPage() {
  ...
  const { data } = useQuery({ queryKey: ["player-stats", activeStat, friendly, seasonId], queryFn: () => api.get<PlayerStat[]>("/league/stats/players", { ...seasonParams, stat: activeStat, friendly: String(friendly) }), staleTime: 0, refetchOnWindowFocus: true, refetchInterval: 30000 });
